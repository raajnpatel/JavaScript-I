...
console.log(`The last car in our inventory is a ${lastCar.car_make} ${lastCar.car_model}.`);
...
let oldCars = carYears.filter(function (over) {
    return over < 2000;
});
...
let BMWAndAudi = inventory.filter(function (euro) {
    return (euro.car_make == "BMW" || euro.car_make == "Audi");
});
